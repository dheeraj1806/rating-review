...
<div class="container">		
	...
	<div id="ratingDetails"> 		
		...
		<div class="row">
			<div class="col-sm-7">
				...
				<?php
				$ratinguery = "SELECT ratingId, itemId, userId, ratingNumber, title, comments, created FROM item_rating where status = '1'";
			...
			<div class="col-sm-12">
				<form id="ratingForm" method="POST">					
					<div class="form-group">
						...
						<input type="hidden" class="form-control" id="itemId" name="itemId" value="123">
					</div>		
					<div class="form-group">
	...
	<div style="margin:50px 0px 0px 0px;">
		<a class="btn btn-default read-more" style="background:#3399ff;color:white" href="rate.php">Back</a>		
	</div>
</div>	
